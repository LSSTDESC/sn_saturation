...
The command \code{make main} compiles \code{main.tex} using the  \code{desc-tex/styles/lsstdescnote.cls} style.
...
The \code{desc-tex/styles/lsstdesc} macros also contain some conventional scientific units like \angstrom, \GeV, \Msun, etc. and some editorial tools for highlighting \FIXME{issues}, \CHECK{text to be checked}, \COMMENT{comments}, and \NEW{new additions}.
